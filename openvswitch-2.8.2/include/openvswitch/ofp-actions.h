...
#define OFPACTS                                                         \
    ...
    OFPACT(SET_L4_TCP_FLAGS,ofpact_l4_flags,    ofpact, "mod_tcp_flags")\
    OFPACT(SET_L4_TCP_SEQ,  ofpact_l4_seq,      ofpact, "mod_tcp_seq")  \
    OFPACT(SET_L4_TCP_ACK,  ofpact_l4_ack,      ofpact, "mod_tcp_ack")  \
...
/* OFPACT_SET_L4_TCP_FLAGS.
 *
 * Used for OFPAT10_SET_TCP_FLAGS. */
struct ofpact_l4_flags {
    struct ofpact ofpact;
    ovs_be16 tcp_flags;
};

/* OFPACT_SET_L4_TCP_SEQ.
 *
 * Used for OFPAT10_SET_TCP_SEQ. */
struct ofpact_l4_seq {
    struct ofpact ofpact;
    ovs_be32 tcp_seq;
};

/* OFPACT_SET_L4_TCP_ACK. 
 *
 * Used for OFPAT10_SET_TCP_ACK. */
struct ofpact_l4_ack {
    struct ofpact ofpact;
    ovs_be32 tcp_ack;
};
